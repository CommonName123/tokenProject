...
import net.proselyte.jwtappdemo.service.utils.DataBaseUtils;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = "net.proselyte.jwtappdemo.repository")
...
public class DbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(UserCredentialsDataSourceAdapter dataSourceSecure,
        ...
        containerEntityManagerFactoryBean.setPackagesToScan("net.proselyte.jwtappdemo.domain");

        Map<String, Object> jpaProperties = new HashMap<>();
        jpaProperties.put(Environment.DIALECT, "net.proselyte.jwtappdemo.repository.CustomPostgreSQL93Dialect");
